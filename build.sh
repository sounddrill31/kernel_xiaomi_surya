...
ZIPNAME="uvite-Ksu$(date '+%Y%m%d-%H%M')-surya.zip"
...
if [ -f "$kernel" ]; then
	...
	elif ! git clone -q https://github.com/CHRISL7/AnyKernel3 -b uvite-ksu-surya; then
	...
	cd AnyKernel3
	git checkout uvite-ksu-surya &> /dev/null
