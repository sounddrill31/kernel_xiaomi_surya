...
static const struct freq_tbl ftbl_gpu_cc_gx_gfx3d_clk_src[] = {
	F(135000000, P_CRC_DIV, 1, 0, 0),
	F(208000000, P_CRC_DIV, 1, 0, 0),
	F(305000000, P_CRC_DIV, 1, 0, 0),
	F(440000000, P_CRC_DIV, 1, 0, 0),
	F(543000000, P_CRC_DIV, 1, 0, 0),
	F(504000000, P_CRC_DIV, 1, 0, 0),
	F(628000000, P_CRC_DIV, 1, 0, 0),
...
static struct clk_rcg2 gpu_cc_gx_gfx3d_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.rate_max = (unsigned long[VDD_GX_NUM]) {
			[VDD_GX_RETENTION] = 2000000,
			[VDD_GX_MIN] = 1700000,
			[VDD_GX_MIN] = 3600000,
			[VDD_GX_MIN] = 65000000,
			[VDD_GX_LOW] = 79000000,
			[VDD_GX_LOW_L1] = 12900000,
			[VDD_GX_NOMINAL] = 19300000,
